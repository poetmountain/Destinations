...
struct AppSplitView: NavigationSplitViewDestinationInterfacing, AppDestinationTypes {
    ...
    init(destination: Destination) {
        self.destinationState = DestinationInterfaceState(destination: destination, state: DefaultDestinationState(destination: destination))
    }
