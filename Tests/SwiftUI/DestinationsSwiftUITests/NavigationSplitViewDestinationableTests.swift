...
@MainActor final class NavigationSplitViewDestinationableTests: XCTestCase, DestinationTypes {
    ...
    func test_column_for_destinationID() {
        let homeDestination = ViewDestination<TestView, TestView.Events, TestDestinationType, ContentType, TestTabType, InteractorType>(destinationType: .detail)
        let groupDestination = TestGroupDestination()
        
        let splitViewDestination = NavigationSplitViewDestination<TestSplitView, TestView.Events, TestDestinationType, ContentType, TestTabType, InteractorType>(destinationType: .splitView, destinationsForColumns: [.sidebar: groupDestination, .content: homeDestination])
    ...
    func test_presentDestination_in_navigationStack_column() {
        ...
        let firstDetailDestination = ViewDestination<TestView, TestView.Events, TestDestinationType, ContentType, TestTabType, InteractorType>(destinationType: TestDestinationType.replacement)
        let secondDetailDestination = ViewDestination<TestView, TestView.Events, TestDestinationType, ContentType, TestTabType, InteractorType>(destinationType: TestDestinationType.replacement)
        
        let splitViewDestination = NavigationSplitViewDestination<TestSplitView, TestSplitView.Events, TestDestinationType, ContentType, TestTabType, InteractorType>(destinationType: .splitView, destinationsForColumns: [.sidebar: homeDestination, .content: navigatorDestination])
    ...
    func test_currentDestination_for_non_group_destination() {
        ...
        let splitViewDestination = NavigationSplitViewDestination<TestSplitView, TestSplitView.Events, TestDestinationType, ContentType, TestTabType, InteractorType>(destinationType: .splitView, destinationsForColumns: [.sidebar: groupDestination, .content: homeDestination])
    ...
    func test_currentDestination_for_group_destination() {
        ...
        let secondDestination = ViewDestination<TestView, TestView.Events, TestDestinationType, ContentType, TestTabType, InteractorType>(destinationType: TestDestinationType.detail)
