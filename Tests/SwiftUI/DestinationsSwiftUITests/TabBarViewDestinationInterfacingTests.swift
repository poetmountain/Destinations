...
@MainActor final class TabBarViewDestinationInterfacingTests: XCTestCase {
    ...
    func test_tabIndex_for_tab() {
        let homeDestination = ViewDestination<TestView, TestView.Events, TestView.DestinationType, TestTabView.ContentType, TestView.TabType, TestView.InteractorType>(destinationType: TestDestinationType.detail)
        let groupDestination = TestGroupDestination()
        let tabsDestination = TabViewDestination<TestTabView, TestTabView.Events, TestTabView.DestinationType, TestTabView.ContentType, TestTabView.TabType, TestTabView.InteractorType>(type: .tabBar, tabDestinations: [homeDestination, groupDestination], tabTypes: [.home, .group], selectedTab: .home)
    ...
    func test_replaceView() {
        ...
        let newDestination = ViewDestination<TestView, TestView.Events, TestView.DestinationType, TestTabView.ContentType, TestView.TabType, TestView.InteractorType>(destinationType: TestDestinationType.detail)
