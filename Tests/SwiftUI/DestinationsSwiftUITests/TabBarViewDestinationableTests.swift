...
@MainActor final class TabBarViewDestinationableTests: XCTestCase, DestinationTypes {
    ...
    func test_tab_for_destinationID() {
        let homeDestination = ViewDestination<TestView, TestView.Events, TestDestinationType, ContentType, TestTabType, InteractorType>(destinationType: TestDestinationType.detail)
        let groupDestination = TestGroupDestination()
        let tabsDestination = TabViewDestination<TestTabView, TestView.Events, TestDestinationType, ContentType, TestTabType, InteractorType>(type: .tabBar, tabDestinations: [homeDestination, groupDestination], tabTypes: [.home, .group], selectedTab: .home)
    ...
    func test_updateSelectedTab_preserve_current_destination_in_nav_stack() {
        ...
        let childDestination = ViewDestination<TestView, TestView.Events, TestDestinationType, ContentType, TestTabType, InteractorType>(destinationType: TestDestinationType.detail)
        
        if let tabsDestination = TabViewDestination<TestTabView, TestView.Events, TestDestinationType, ContentType, TestTabType, InteractorType>(type: .tabBar, tabDestinations: [homeDestination, navigationStackDestination], tabTypes: [.home, .group], selectedTab: .home) {
    ...
    func test_replaceChild() {
        let homeDestination = ViewDestination<TestView, TestView.Events, TestDestinationType, ContentType, TestTabType, InteractorType>(destinationType: TestDestinationType.detail)
        let groupDestination = TestGroupDestination()
        let presentedDestination = ViewDestination<TestView, TestView.Events, TestDestinationType, ContentType, TestTabType, InteractorType>(destinationType: TestDestinationType.detail)
        
        if let tabsDestination = TabViewDestination<TestTabView, TestView.Events, TestDestinationType, ContentType, TestTabType, InteractorType>(type: .tabBar, tabDestinations: [homeDestination, groupDestination], tabTypes: [.home, .group], selectedTab: .home) {
    ...
    func test_presentDestination_in_single_view_tab() {
        let homeDestination = ViewDestination<TestView, TestView.Events, TestDestinationType, ContentType, TestTabType, InteractorType>(destinationType: TestDestinationType.detail)
        let groupDestination = TestGroupDestination()
        let presentedDestination = ViewDestination<TestView, TestView.Events, TestDestinationType, ContentType, TestTabType, InteractorType>(destinationType: TestDestinationType.replacement)
    ...
    func test_presentDestination_in_navigationStack_tab() {
        ...
        let thirdDestination = ViewDestination<TestView, TestView.Events, TestDestinationType, ContentType, TestTabType, InteractorType>(destinationType: TestDestinationType.detail)
    ...
    func test_currentDestination_for_group_destination() {
        let homeDestination = ViewDestination<TestView, TestView.Events, TestDestinationType, ContentType, TestTabType, InteractorType>(destinationType: TestDestinationType.home)
        let navigationStackDestination = TestNavigatorDestination<TestGroupView>()
        let navView = TestGroupView(destination: navigationStackDestination)
        navigationStackDestination.assignAssociatedView(view: navView)
        ...
        let tabsDestination = TabViewDestination<TestTabView, TestView.Events, TestDestinationType, ContentType, TestTabType, InteractorType>(type: .tabBar, tabDestinations: [homeDestination, navigationStackDestination], tabTypes: [.home, .group], selectedTab: .home)
        try? tabsDestination?.presentDestination(destination: childDestination, in: .group)
    ...
    func test_updateTabViews() {
        let homeDestination = ViewDestination<TestView, TestView.Events, TestDestinationType, ContentType, TestTabType, InteractorType>(destinationType: TestDestinationType.detail)
        let groupDestination = TestGroupDestination()
        let newDestination = ViewDestination<TestView, TestView.Events, TestDestinationType, ContentType, TestTabType, InteractorType>(destinationType: TestDestinationType.detail)
        let tabsDestination = TabViewDestination<TestTabView, TestView.Events, TestDestinationType, ContentType, TestTabType, InteractorType>(type: .tabBar, tabDestinations: [homeDestination, groupDestination], tabTypes: [.home, .group], selectedTab: .home)
