...
@MainActor public protocol Destinationable<DestinationType, ContentType, TabType>: AnyObject, Identifiable {
    ...
    /// Performs the interface action associated with the specified user interaction type. This action could be a Destination presentation or a request to an Interactor.
    ...
    func performAction(for interactionType: UserInteractionType, content: ContentType?) throws
