...
public extension ViewDestinationProviding {
    ...
    internal func buildAndConfigureDestination(for configuration: DestinationPresentation<DestinationType, ContentType, TabType>, appFlow: some ViewFlowable<DestinationType, ContentType, TabType>) -> Destination? {
