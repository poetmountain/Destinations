...
public final class Action<InteractorType: InteractorTypeable, ContentType: ContentTypeable>: ActionPerformable {
    ...
    public init(actionType: any InteractorRequestActionTypeable, identifier: (any ActionIdentifying)? = nil, assistant: any AsyncInteractorAssisting<InteractorType, ContentType>, resultHandler: any InteractorResultHandling<InteractorType, ContentType>, outputConduit: (any ActionSequenceConduiting<ContentType>)?, shouldEndParentTaskOnFailure: Bool = false, shouldSaveResult: Bool = true) {
    ...
    public func perform(with content: ContentType?, sequenceOutputs: ActionCollectionResults<ContentType>) async -> Result<ActionCollectionResults<ContentType>, any Error> {
        ...
        let result = await assistant.asyncRequest(destination: resultHandler, actionType: actionType, content: content)
